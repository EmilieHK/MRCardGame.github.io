...
<div> <ul class="icons alt">
			<li><a href="https://github.com/AnPerret/Evaluation-Repository/raw/main/Image%20Targets/ImageTargets.pdf" class="button icon fa-download">Image Targets</a></li>
	  </ul>
</div>
...
<div> <ul class="icons alt">
			<li><a href="https://github.com/AnPerret/Evaluation-Repository/raw/main/Image%20Targets/ImageTargets.pdf" class="button alt icon fa-github">More Quizzes</a></li>
	  </ul>
</div>
